...
class PascalPlugin (QObject) :

   def __init__ (self, main_window) :
       super (PascalPlugin, self).__init__ (main_window)
       self.win = main_window

       self.pluginMenu = self.win.menuBar().addMenu ("Pascal")
   ...
   def build (self, rebuild) :
       ...
       # sourceFileName = "/big/src/ultibo/source/rtl/ultibo/core/usb.pas"
       sourceFileName = "pas/examples/idedemo.pas"
       # sourceFileName = "pas/examples/binio.pas"

       grammarFileName = "pas/pas.g"
       ...
       compiler_module = self.win.loadModule ("pas_comp")
       ...
       p2c_module = self.win.loadModule ("p2c.py")
